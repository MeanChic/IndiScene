...
insert into artist(ARTIST_ID,ATIST_PASSWORD,ARTIST_NAME,ARTIST_NICKNAME,ARTIST_PHONE,ARTIST_ZIPCODE, 			   
 ...
 --2 performboard �׽�Ʈ�Ҷ� �� �ӽ� ���̵� ���� (�ʼ�)
 
 alter table performboard modify(content VARCHAR2(4000));
 --3 ���� �ʵ� ũ�Ⱑ �ʹ� �۾Ƽ� Ȯ��
 
  ALTER TABLE artist RENAME COLUMN atist_password TO artist_password;
 --4 atist�� �Ǿ� �ִ°� artist��(�ʼ�)
 
 alter table performboard modify(file_path varchar2(2000));
 --5 ���� ���ϰ�� ������ file_path �ʹ� �۾Ƽ� Ȯ��
 ...
 update performboard set nvl(count,0)=count+1 where board_num='m3'
 
 delete from performboard;
