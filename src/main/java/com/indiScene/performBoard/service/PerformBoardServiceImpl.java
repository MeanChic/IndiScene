...
public class PerformBoardServiceImpl implements PerformBoardService {
	...
	@Autowired
	private PerformBoardDao marketBoardDao;
	...
	public void enterBoard(ModelAndView mav) {
		...
		List<PerformBoardDto> marketList=null;
...
//		//멀티파일 처리 끝
	...
	public void read(ModelAndView mav) {
		...
		PerformBoardDto marketBoardDto=marketBoardDao.read(boardNumber);
...
//	}
	...
	public void deleteOk(ModelAndView mav) {
		...
		if(password.equals(realPass)){
			...
			PerformBoardDto marketBoardDto=marketBoardDao.read(board_num);
...
//			}
	...
	public void update(ModelAndView mav) {
		...
		PerformBoardDto marketBoardDto=marketBoardDao.update(board_num);
