...
<body>
	...
	<form class="form_style"  action="${root }/placeBoard/write.do"  method="post" onsubmit="return checkForm(this)" enctype="multipart/form-data">	
		<!-- <input type="hidden" name="board_num" value="${boardNumber }"/>-->
			
		<div style="width:598px; height:15px; border-width:2px; text-align:right; padding:15px 0px 0px 0px; border-bottom-width:0px;">
				<a href="${root}/placeBoard/enterBoard.do">글목록</a>
		</div>
		...
		<div class="line" style= text-align:center;>
			...
			<input type="button" value="목록보기" onclick="location.href='${root}/placeBoard/enterBoard.do'"/>
		</div>
	</form>
</body>
</html>